 ...
 */
class Version20160704164348 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE recommend is_recommend TINYINT(1) DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE is_recommend recommend TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
}
