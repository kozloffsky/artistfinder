...
class Version20160915024930 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE Price (id INT AUTO_INCREMENT NOT NULL, rate_id INT DEFAULT NULL, amount NUMERIC(10, 0) NOT NULL, UNIQUE INDEX UNIQ_B090DDDBC999F9F (rate_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE Package (id INT AUTO_INCREMENT NOT NULL, performance_id INT DEFAULT NULL, service_id INT DEFAULT NULL, name VARCHAR(128) NOT NULL, deleted_time DATETIME DEFAULT NULL, INDEX IDX_11D55E09B91ADEEE (performance_id), INDEX IDX_11D55E09ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("ALTER TABLE Price ADD CONSTRAINT FK_B090DDDBC999F9F FOREIGN KEY (rate_id) REFERENCES Rate (id)");
