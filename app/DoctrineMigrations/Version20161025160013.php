...
class Version20161025160013 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE DocumentTechnicalRequirement (id INT AUTO_INCREMENT NOT NULL, technical_requirement_id INT DEFAULT NULL, name VARCHAR(128) NOT NULL, size INT DEFAULT NULL, file VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, INDEX IDX_DF8BA583587756CD (technical_requirement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
